...
const POSTS = [
  {
    ...
    excerpt:
      "Turn your daily dose of Organic Mango Tang into a refreshing sunset mocktail with jalapeño and lime.",
    category: "Recipe",
  ...
  },
  {
    ...
    excerpt:
      "Roasted organic sweet potatoes, kale, and a zesty Citrus Sun dressing make for the perfect autumn lunch.",
    category: "Recipe",
  ...
  },
  {
    ...
    excerpt:
      "Discover the science behind beetroot and ginger, and how they work together to heal your microbiome.",
    category: "Wellness",
  ...
  },
  {
    ...
    excerpt:
      "Feeling sluggish? Reboot your system with our guided 3-day juice cleanse featuring Celery Calm and Green Glow.",
    category: "Guide",
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-organo-gray max-w-2xl mx-auto text-lg leading-relaxed">
            Nourish your body and mind with our collection of wholesome recipes, farm updates, and
        ...
        >
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-2/5 p-10 md:p-14 flex flex-col justify-center">
              <span className="text-organo-pistachio font-bold uppercase tracking-wider text-sm mb-4">
                Featured Recipe
              </span>
              <h2 className="font-serif text-3xl md:text-4xl text-organo-green mb-4">
                Summer Berry Blast Smoothie Bowl
              </h2>
              <p className="text-organo-gray mb-8 leading-relaxed">
                Start your morning right with an antioxidant-packed bowl featuring our Berry Blast
                juice, fresh blueberries, and homemade granola.
              </p>
              <div className="flex items-center text-sm text-gray-500 gap-6 mb-8">
                <div className="flex items-center gap-2">
                  <User size={16} /> Sarah Jenkins
                </div>
                <div className="flex items-center gap-2">
